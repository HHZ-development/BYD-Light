...
<recipetype:mekanism:metallurgic_infusing>.remove(<item:mekaevolution:absolute_control_circuit>);
//<recipetype:mekanism:metallurgic_infusing>.addRecipe("mekaevolution:metallurgic_infusing/absolute_control_circuit", ItemStackIngredient.from(<item:mekanism:ultimate_control_circuit>), InfusionStackIngredient.from(<infuse_type:mekanism:uranium_oxide> * 10), <item:mekaevolution:absolute_control_circuit>);